...
export default function SetupPage() {
  ...
  function toggleModule(module: ModuleKey) {
    const enabled = profile.enabledModules.includes(module);
    if (enabled && profile.enabledModules.length === 1) {
    ...
    setProfile({ ...profile, enabledModules: enabled ? profile.enabledModules.filter((item) => item !== module) : [...profile.enabledModules, module] });
    setSaved(false);
    setNotice("");
  }
